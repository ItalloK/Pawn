<?php 
    require ('conexao.php');
    $sql = "SELECT ID, Nick, Skin, TemVip,Profissao, Matou, Morreu 
            FROM jogadores ORDER BY Matou DESC LIMIT 10";
    $res = $conn->query($sql);
    $qtd = $res->num_rows;
?>
<table class="table align-middle mb-0 bg-white">
    <h4>Ranking jogadores com mais K/D</h4>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p class="fw-normal mb-1"><?php echo $row['Matou']." / ".$row['Morreu']; ?></p>
