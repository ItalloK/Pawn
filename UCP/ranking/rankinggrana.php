<?php 
    require ('conexao.php');
    require ('funcoes.php');
    $sql = "SELECT ID, Nick, Skin, TemVip,Profissao, Dinheiro, SaldoBanco, (Dinheiro + SaldoBanco) AS Money 
            FROM jogadores ORDER BY Money DESC LIMIT 10";
    $res = $conn->query($sql);
    $qtd = $res->num_rows;
?>
<table class="table align-middle mb-0 bg-white">
    <h4>Ranking jogadores com mais Grana</h4>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        <p class="fw-normal mb-1"><?php echo formatMoney($row['Money']); ?></p>
